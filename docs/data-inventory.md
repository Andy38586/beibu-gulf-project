...
| 12 | 平陆运河路线 | ✅ 示意线已画 | geojson | 4326 | — | 运河因子（**示意版,正式前按环评图件校准**） |
...
### 10. ESA WorldCover 10m（土地类型，✅ 已到手）
- 来源：ESA，AWS 公开桶 `esa-worldcover`（eu-central-1），3°×3° 瓦片（注意：**经纬度需为 3 的倍数**）
- 范围：N18/N21 × E105/E108 共 4 瓦片 ≈ 289MB；**耕地掩膜已提取**（`*_cropland.tif` 4 个，class 40，区域合计 52,505 km²）
