...
const FACILITY_CONFIG = {
  hospital: { label: '医院', file: '/data/qz_hospital.json', color: '#e74c3c' },
  primary_school: { label: '小学', file: '/data/qz_primary_school.json', color: '#3498db' },
  middle_school: { label: '中学', file: '/data/qz_middle_school.json', color: '#9b59b6' },
  park: { label: '公园', file: '/data/qz_park.json', color: '#2ecc71' },
  bus_station: { label: '公交站', file: '/data/qz_bus_station.json', color: '#f39c12' },
  mall: { label: '商场', file: '/data/qz_mall_and_supermarket.json', color: '#1abc9c' },
}
