...
--   docker exec -i beibu-postgis psql -U postgres -d beibu-gulf-data                   < tools/roads/roads-derive.sql
--   docker exec -i beibu-postgis psql -U postgres -d beibu-gulf-data -v tbl=roads      < tools/roads/roads-derive.sql
--
